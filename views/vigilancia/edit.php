...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Editar Vigilância Veicular</h1>
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            <a href="vigilancia.php" class="btn btn-sm btn-outline-secondary">
                <i class="fas fa-arrow-left me-1"></i>Voltar
            </a>
            <a href="vigilancia.php?action=show&id=<?php echo $vigilancia['id_vigilancia_veicular']; ?>" class="btn btn-sm btn-outline-info">
...
<form method="POST" action="vigilancia.php?action=update">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cliente" name="cliente" required
                                       value="<?php echo isset($_SESSION['old_input']['cliente']) ? htmlspecialchars($_SESSION['old_input']['cliente']) : htmlspecialchars($vigilancia['cliente']); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="servico" name="servico" required
                                       value="<?php echo isset($_SESSION['old_input']['servico']) ? htmlspecialchars($_SESSION['old_input']['servico']) : htmlspecialchars($vigilancia['servico']); ?>"
                                       placeholder="Ex: Vigilância Veicular, Monitoramento">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="solicitante" name="solicitante" required
                                       value="<?php echo isset($_SESSION['old_input']['solicitante']) ? htmlspecialchars($_SESSION['old_input']['solicitante']) : htmlspecialchars($vigilancia['solicitante']); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="motivo" name="motivo" required
                                       value="<?php echo isset($_SESSION['old_input']['motivo']) ? htmlspecialchars($_SESSION['old_input']['motivo']) : htmlspecialchars($vigilancia['motivo']); ?>"
                                       placeholder="Ex: Segurança preventiva, Monitoramento">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="status_vigilancia" name="status_vigilancia">
                                    <?php 
                                    $statusSelecionado = isset($_SESSION['old_input']['status_vigilancia']) ? $_SESSION['old_input']['status_vigilancia'] : $vigilancia['status_vigilancia'];
                                    ?>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="placa_do_veiculo" name="placa_do_veiculo" required maxlength="8"
                                       value="<?php echo isset($_SESSION['old_input']['placa_do_veiculo']) ? htmlspecialchars($_SESSION['old_input']['placa_do_veiculo']) : htmlspecialchars($vigilancia['placa_do_veiculo']); ?>"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="marca_veiculo" name="marca_veiculo"
                                       value="<?php echo isset($_SESSION['old_input']['marca_veiculo']) ? htmlspecialchars($_SESSION['old_input']['marca_veiculo']) : htmlspecialchars($vigilancia['marca_veiculo']); ?>"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="modelo_veiculo" name="modelo_veiculo"
                                       value="<?php echo isset($_SESSION['old_input']['modelo_veiculo']) ? htmlspecialchars($_SESSION['old_input']['modelo_veiculo']) : htmlspecialchars($vigilancia['modelo_veiculo']); ?>"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cor_veiculo" name="cor_veiculo"
                                       value="<?php echo isset($_SESSION['old_input']['cor_veiculo']) ? htmlspecialchars($_SESSION['old_input']['cor_veiculo']) : htmlspecialchars($vigilancia['cor_veiculo']); ?>"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="ano_veiculo" name="ano_veiculo" min="1900" max="2030"
                                       value="<?php echo isset($_SESSION['old_input']['ano_veiculo']) ? htmlspecialchars($_SESSION['old_input']['ano_veiculo']) : htmlspecialchars($vigilancia['ano_veiculo']); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="chassi_veiculo" class="form-label">Chassi</label>
                                <input type="text" class="form-control" id="chassi_veiculo" name="chassi_veiculo" maxlength="17"
                                       value="<?php echo isset($_SESSION['old_input']['chassi_veiculo']) ? htmlspecialchars($_SESSION['old_input']['chassi_veiculo']) : htmlspecialchars($vigilancia['chassi_veiculo']); ?>"
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cep" name="cep" maxlength="9"
                                       value="<?php echo isset($_SESSION['old_input']['cep']) ? htmlspecialchars($_SESSION['old_input']['cep']) : htmlspecialchars($vigilancia['cep']); ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="estado" name="estado" maxlength="2"
                                       value="<?php echo isset($_SESSION['old_input']['estado']) ? htmlspecialchars($_SESSION['old_input']['estado']) : htmlspecialchars($vigilancia['estado']); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cidade" name="cidade"
                                       value="<?php echo isset($_SESSION['old_input']['cidade']) ? htmlspecialchars($_SESSION['old_input']['cidade']) : htmlspecialchars($vigilancia['cidade']); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="endereco_da_vigilancia" name="endereco_da_vigilancia" required
                                       value="<?php echo isset($_SESSION['old_input']['endereco_da_vigilancia']) ? htmlspecialchars($_SESSION['old_input']['endereco_da_vigilancia']) : htmlspecialchars($vigilancia['endereco_da_vigilancia']); ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="numero" name="numero"
                                       value="<?php echo isset($_SESSION['old_input']['numero']) ? htmlspecialchars($_SESSION['old_input']['numero']) : htmlspecialchars($vigilancia['numero']); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="latitude" name="latitude"
                                       value="<?php echo isset($_SESSION['old_input']['latitude']) ? htmlspecialchars($_SESSION['old_input']['latitude']) : htmlspecialchars($vigilancia['latitude']); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="longitude" name="longitude"
                                       value="<?php echo isset($_SESSION['old_input']['longitude']) ? htmlspecialchars($_SESSION['old_input']['longitude']) : htmlspecialchars($vigilancia['longitude']); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="tempo_no_local" name="tempo_no_local" min="0"
                                       value="<?php echo isset($_SESSION['old_input']['tempo_no_local']) ? htmlspecialchars($_SESSION['old_input']['tempo_no_local']) : htmlspecialchars($vigilancia['tempo_no_local']); ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="quilometragem" name="quilometragem" min="0" step="0.1"
                                       value="<?php echo isset($_SESSION['old_input']['quilometragem']) ? htmlspecialchars($_SESSION['old_input']['quilometragem']) : htmlspecialchars($vigilancia['quilometragem']); ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="valor_vigilancia" name="valor_vigilancia" min="0" step="0.01"
                                       value="<?php echo isset($_SESSION['old_input']['valor_vigilancia']) ? htmlspecialchars($_SESSION['old_input']['valor_vigilancia']) : htmlspecialchars($vigilancia['valor_vigilancia']); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descricao_dos_fatos" name="descricao_dos_fatos" rows="4"
                                  placeholder="Descreva detalhadamente o que aconteceu durante a vigilância..."><?php echo isset($_SESSION['old_input']['descricao_dos_fatos']) ? htmlspecialchars($_SESSION['old_input']['descricao_dos_fatos']) : htmlspecialchars($vigilancia['descricao_dos_fatos']); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="hora_solicitada" name="hora_solicitada"
                               value="<?php echo isset($_SESSION['old_input']['hora_solicitada']) ? $_SESSION['old_input']['hora_solicitada'] : (isset($vigilancia['hora_solicitada']) ? date('Y-m-d\TH:i', strtotime($vigilancia['hora_solicitada'])) : ''); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="hora_local" name="hora_local"
                               value="<?php echo isset($_SESSION['old_input']['hora_local']) ? $_SESSION['old_input']['hora_local'] : (isset($vigilancia['hora_local']) ? date('Y-m-d\TH:i', strtotime($vigilancia['hora_local'])) : ''); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-control" id="hora_saida" name="hora_saida"
                               value="<?php echo isset($_SESSION['old_input']['hora_saida']) ? $_SESSION['old_input']['hora_saida'] : (isset($vigilancia['hora_saida']) ? date('Y-m-d\TH:i', strtotime($vigilancia['hora_saida'])) : ''); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="vigilancia.php?action=show&id=<?php echo $vigilancia['id_vigilancia_veicular']; ?>" class="btn btn-outline-info">
                            <i class="fas fa-eye me-1"></i>Visualizar
                        </a>
...
document.getElementById('valor_vigilancia').addEventListener('blur', function(e) {
    if (e.target.value) {
        const valor = parseFloat(e.target.value);
        if (!isNaN(valor)) {
...
// Validação de chassi (17 dígitos)
document.getElementById('chassi_veiculo').addEventListener('input', function(e) {
    e.target.value = e.target.value.replace(/[^A-Za-z0-9]/g, '').toUpperCase();
});

document.getElementById('chassi_veiculo').addEventListener('blur', function(e) {
    if (e.target.value && e.target.value.length !== 17) {
        e.target.classList.add('is-invalid');
        if (!document.getElementById('chassi-error')) {
            const error = document.createElement('div');
            error.id = 'chassi-error';
            error.className = 'invalid-feedback';
            error.textContent = 'Chassi deve ter exatamente 17 caracteres';
            e.target.parentNode.appendChild(error);
        }
    } else {
        e.target.classList.remove('is-invalid');
        const error = document.getElementById('chassi-error');
        if (error) error.remove();
    }
});
</script>
