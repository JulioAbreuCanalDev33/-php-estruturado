...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Nova Ocorrência Veicular</h1>
...
<form method="POST" action="ocorrencias.php?action=store">
    <div class="row">
        <div class="col-md-8">
            <!-- Dados Básicos -->
            <div class="card mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tipo_de_ocorrencia" name="tipo_de_ocorrencia" required>
                                    ...
                                    <?php 
                                    $tipoSelecionado = isset($_SESSION['old_input']['tipo_de_ocorrencia']) ? $_SESSION['old_input']['tipo_de_ocorrencia'] : '';
                                    ?>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="numero_bo" name="numero_bo"
                                       value="<?php echo isset($_SESSION['old_input']['numero_bo']) ? htmlspecialchars($_SESSION['old_input']['numero_bo']) : ''; ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="endereco_da_ocorrencia" name="endereco_da_ocorrencia" required
                                       value="<?php echo isset($_SESSION['old_input']['endereco_da_ocorrencia']) ? htmlspecialchars($_SESSION['old_input']['endereco_da_ocorrencia']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descricao_dos_fatos" name="descricao_dos_fatos" rows="4"
                                  placeholder="Descreva detalhadamente o que aconteceu..."><?php echo isset($_SESSION['old_input']['descricao_dos_fatos']) ? htmlspecialchars($_SESSION['old_input']['descricao_dos_fatos']) : ''; ?></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        Preencha latitude e longitude para localização precisa.
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i>Salvar Ocorrência
                        </button>
