...
<?php if (!isAdmin()): ?>
    <div class="alert alert-danger">
        ...
        Apenas administradores podem cadastrar prestadores de serviço.
    </div>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Novo Prestador de Serviço</h1>
...
<form method="POST" action="prestadores.php?action=store">
    <div class="row">
        <div class="col-md-8">
            <!-- Dados Pessoais -->
            <div class="card mb-3">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nome_prestador" name="nome_prestador" required
                                       value="<?php echo isset($_SESSION['old_input']['nome_prestador']) ? htmlspecialchars($_SESSION['old_input']['nome_prestador']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cpf_prestador" name="cpf_prestador" required maxlength="14"
                                       value="<?php echo isset($_SESSION['old_input']['cpf_prestador']) ? htmlspecialchars($_SESSION['old_input']['cpf_prestador']) : ''; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="servico_prestador" name="servico_prestador" required
                                       value="<?php echo isset($_SESSION['old_input']['servico_prestador']) ? htmlspecialchars($_SESSION['old_input']['servico_prestador']) : ''; ?>"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email_prestador" name="email_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['email_prestador']) ? htmlspecialchars($_SESSION['old_input']['email_prestador']) : ''; ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="telefone_1_prestador" name="telefone_1_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['telefone_1_prestador']) ? htmlspecialchars($_SESSION['old_input']['telefone_1_prestador']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="telefone_2_prestador" name="telefone_2_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['telefone_2_prestador']) ? htmlspecialchars($_SESSION['old_input']['telefone_2_prestador']) : ''; ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cep_prestador" name="cep_prestador" maxlength="9"
                                       value="<?php echo isset($_SESSION['old_input']['cep_prestador']) ? htmlspecialchars($_SESSION['old_input']['cep_prestador']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="estado_prestador" name="estado_prestador" maxlength="2"
                                       value="<?php echo isset($_SESSION['old_input']['estado_prestador']) ? htmlspecialchars($_SESSION['old_input']['estado_prestador']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cidade_prestador" name="cidade_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['cidade_prestador']) ? htmlspecialchars($_SESSION['old_input']['cidade_prestador']) : ''; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="endereco_prestador" name="endereco_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['endereco_prestador']) ? htmlspecialchars($_SESSION['old_input']['endereco_prestador']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="numero_prestador" name="numero_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['numero_prestador']) ? htmlspecialchars($_SESSION['old_input']['numero_prestador']) : ''; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bairro_prestador" name="bairro_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['bairro_prestador']) ? htmlspecialchars($_SESSION['old_input']['bairro_prestador']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="complemento_prestador" name="complemento_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['complemento_prestador']) ? htmlspecialchars($_SESSION['old_input']['complemento_prestador']) : ''; ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="banco_prestador" name="banco_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['banco_prestador']) ? htmlspecialchars($_SESSION['old_input']['banco_prestador']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="agencia_prestador" name="agencia_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['agencia_prestador']) ? htmlspecialchars($_SESSION['old_input']['agencia_prestador']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="conta_prestador" name="conta_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['conta_prestador']) ? htmlspecialchars($_SESSION['old_input']['conta_prestador']) : ''; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="pix_prestador" name="pix_prestador"
                                       value="<?php echo isset($_SESSION['old_input']['pix_prestador']) ? htmlspecialchars($_SESSION['old_input']['pix_prestador']) : ''; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tipo_conta_prestador" name="tipo_conta_prestador">
                                    ...
                                    <?php 
                                    $tipoSelecionado = isset($_SESSION['old_input']['tipo_conta_prestador']) ? $_SESSION['old_input']['tipo_conta_prestador'] : '';
                                    ?>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        Apenas administradores podem gerenciar prestadores.
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i>Salvar Prestador
                        </button>
